...
/***Right SideBar**/
function mySidebar_widget_setup() {
	register_sidebar( array(
...
add_action( 'widgets_init', 'mySidebar_widget_setup' );

/**News/ Events Side bar**/
function newsSidebar_widget_setup() {
	register_sidebar( array(
		'name'          => esc_html__( 'news-sideBar' ),
		'id'            => 'sidebar-3',
...
add_action( 'widgets_init', 'newsSidebar_widget_setup' );
...
function actionSidebar_widget_setup() {
	register_sidebar( array(
		'name'          => esc_html__( 'action-sideBar' ),
		'id'            => 'sidebar-4',
		'description'   => 'fourth sidebar',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
add_action( 'widgets_init', 'actionSidebar_widget_setup' );
